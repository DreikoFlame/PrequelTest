...
public class Texture2dProgram {
     ...
     */
    public Texture2dProgram(FilterEffect filterEffect) {
        mFilter = filterEffect;

        mTextureTarget = GLES11Ext.GL_TEXTURE_EXTERNAL_OES;
        mProgramHandle = GlUtil.createProgram(VERTEX_SHADER, mFilter.getShader());

        if (mProgramHandle == 0) {
            throw new RuntimeException("Unable to create program");
        }
        Log.d(TAG, "Created program " + mProgramHandle + " (" + mFilter.getFilterName() + ")");
    ...
    /**
     * Returns the filter code.
     */
    public int getFilterCode() {
        return mFilter.getFilterCode();
    }
